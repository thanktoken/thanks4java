...
/**
 * {@link ThankMessage} for a simple <em>transfer</em> of a {@link io.github.thanktoken.core.api.token.ThankToken} from a
...
public class ThankMessageTokenTransfer extends AbstractThankMessage {
  ...
  /**
   * @return the {@link ThankTokenReferenceType} pointing to the {@link io.github.thanktoken.core.api.token.ThankToken} the
