...
public class ThankTransactionBeanTest extends TestCase {
  ...
  public void testFields() {
    ...
    checkField(ThankTransactionField.TIMESTAMP, Instant.now(), ThankTransaction::getTimestamp, ThankTransactionBean::setTimestamp, fields);
    checkField(ThankTransactionField.RECIPIENT, new SecurityPublicKeyGeneric(new byte[0], (PublicKey) null), ThankTransaction::getRecipient,
        ThankTransactionBean::setRecipient, fields);
    checkField(ThankTransactionField.PUBLIC_PURPOSE, "Hello World", ThankTransaction::getPublicPurpose, ThankTransactionBean::setPublicPurpose, fields);
    checkField(ThankTransactionField.ENCRYPTED_PURPOSE, TEST_ENCRYPTED_DATA, ThankTransaction::getEncryptedPurpose, ThankTransactionBean::setEncryptedPurpose,
        fields);
    ...
    checkField(ThankTransactionField.REFERENCES, Arrays.asList(TEST_REFERENCE, TEST_REFERENCE), ThankTransaction::getReferences,
        ThankTransactionBean::setReferenceList, fields);
